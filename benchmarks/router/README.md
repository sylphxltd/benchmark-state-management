...
- **⚖️ Best Balance**: Wouter - Great performance (70.0/100) with good ecosystem
...
| 🥈 2 | **[Wouter](https://github.com/molefrog/wouter)** | 73.4/100 | 73% of fastest | [📦](https://www.npmjs.com/package/wouter) [📊](https://bundlephobia.com/package/wouter) |
...
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Zen Router](https://github.com/SylphxAI/zen-router)** | 100.0/100 | 100% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen-router) [📊](https://bundlephobia.com/package/@sylphx/zen-router) |
| 🥈 2 | **[Wouter](https://github.com/molefrog/wouter)** | 70.0/100 | 70% of fastest | [📦](https://www.npmjs.com/package/wouter) [📊](https://bundlephobia.com/package/wouter) |
...
| **[Wouter](https://github.com/molefrog/wouter)** | **70.0** | **2.49 KB** | Minimalist-friendly ~2.1KB routing for React and P... | General purpose... |
...
| React Router | 18K | 0.057ms | 0.079ms | 1000 |
...
| Wouter | 8.1M | 0.000ms | 0.000ms | 1000 |
| React Router | 47K | 0.022ms | 0.039ms | 1000 |
| React Router | 13K | 0.080ms | 0.117ms | 1000 |
...
| React Router | 19K | 0.054ms | 0.075ms | 1000 |
...
| Wouter | 1.7M | 0.001ms | 0.001ms | 1000 |
| React Router | 75K | 0.014ms | 0.027ms | 1000 |
| React Router | 21K | 0.050ms | 0.076ms | 1000 |
...
| React Router | 19K | 0.056ms | 0.086ms | 1000 |
...
| React Router | 17K | 0.058ms | 0.084ms | 1000 |
...
| React Router | 11K | 0.092ms | 0.119ms | 1000 |
...
| Wouter | 326K | 0.003ms | 0.005ms | 1000 |
| React Router | 7K | 0.137ms | 0.173ms | 1000 |
| React Router | 2K | 0.452ms | 0.941ms | 1000 |
...
| Wouter | 885K | 0.001ms | 0.002ms | 1000 |
| React Router | 56K | 0.019ms | 0.033ms | 1000 |
| React Router | 13K | 0.080ms | 0.133ms | 1000 |
...
*Generated on 2025-11-18T06:26:52.048Z*
