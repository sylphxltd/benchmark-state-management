...
- **⚡ Maximum Performance**: Zen Router - Fastest overall with 97.8/100 score
- **⚖️ Best Balance**: SolidJS Router - Great performance (96.6/100) with good ecosystem
...
| 🥈 2 | **[SolidJS Router](https://github.com/solidjs/solid-router)** | 97.6/100 | 98% of fastest | [📦](https://www.npmjs.com/package/@solidjs/router) [📊](https://bundlephobia.com/package/@solidjs/router) |
| 🥉 3 | **[Wouter](https://github.com/molefrog/wouter)** | 80.0/100 | 81% of fastest | [📦](https://www.npmjs.com/package/wouter) [📊](https://bundlephobia.com/package/wouter) |
...
| Rank | Library | Overall Score | Relative Performance | Links |
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Zen Router](https://github.com/SylphxAI/zen-router)** | 97.8/100 | 100% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen-router) [📊](https://bundlephobia.com/package/@sylphx/zen-router) |
| 🥈 2 | **[SolidJS Router](https://github.com/solidjs/solid-router)** | 96.6/100 | 99% of fastest | [📦](https://www.npmjs.com/package/@solidjs/router) [📊](https://bundlephobia.com/package/@solidjs/router) |
| 🥉 3 | **[Wouter](https://github.com/molefrog/wouter)** | 84.9/100 | 87% of fastest | [📦](https://www.npmjs.com/package/wouter) [📊](https://bundlephobia.com/package/wouter) |
...
|---------|:-----:|:------------------:|-------------|----------|
| **[Zen Router](https://github.com/SylphxAI/zen-router)** | **97.8** | **1.57 KB** | Tiny and fast router with regex-based matching... | General purpose... |
| **[SolidJS Router](https://github.com/solidjs/solid-router)** | **96.6** | **9.23 KB** | Universal router for Solid with nested routing and... | General purpose... |
| **[Wouter](https://github.com/molefrog/wouter)** | **84.9** | **2.49 KB** | Minimalist-friendly ~2.1KB routing for React and P... | General purpose... |
...
| Wouter | 6.3M | 0.000ms | 0.000ms | 1000 |
| React Router | 51K | 0.020ms | 0.036ms | 1000 |
| React Router | 18K | 0.061ms | 0.131ms | 1000 |
...
| Wouter | 7.1M | 0.000ms | 0.001ms | 1000 |
| React Router | 47K | 0.022ms | 0.039ms | 1000 |
| React Router | 14K | 0.076ms | 0.145ms | 1000 |
...
| React Router | 20K | 0.050ms | 0.079ms | 1000 |
...
| React Router | 22K | 0.047ms | 0.079ms | 1000 |
...
| React Router | 19K | 0.059ms | 0.119ms | 1000 |
...
| Wouter | 2.1M | 0.001ms | 0.001ms | 1000 |
| React Router | 50K | 0.020ms | 0.035ms | 1000 |
| React Router | 19K | 0.055ms | 0.082ms | 1000 |
...
| React Router | 12K | 0.084ms | 0.114ms | 1000 |
...
| Wouter | 399K | 0.003ms | 0.004ms | 1000 |
| React Router | 7K | 0.137ms | 0.173ms | 1000 |
| React Router | 2K | 0.411ms | 1.002ms | 1000 |
...
| Wouter | 1.2M | 0.001ms | 0.001ms | 1000 |
| React Router | 56K | 0.019ms | 0.033ms | 1000 |
| React Router | 14K | 0.073ms | 0.101ms | 1000 |
...
*Generated on 2025-11-15T18:07:05.771Z*
