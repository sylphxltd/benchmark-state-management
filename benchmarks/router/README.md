...
- **⚡ Maximum Performance**: Zen Router - Fastest overall with 98.9/100 score
- **⚖️ Best Balance**: SolidJS Router - Great performance (98.3/100) with good ecosystem
...
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Zen Router](https://github.com/SylphxAI/zen-router)** | 98.9/100 | 100% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen-router) [📊](https://bundlephobia.com/package/@sylphx/zen-router) |
...
| 🥉 3 | **[Wouter](https://github.com/molefrog/wouter)** | 11.9/100 | 12% of fastest | [📦](https://www.npmjs.com/package/wouter) [📊](https://bundlephobia.com/package/wouter) |
...
|---------|:-----:|:------------------:|-------------|----------|
| **[Zen Router](https://github.com/SylphxAI/zen-router)** | **98.9** | **1.57 KB** | Tiny and fast router with regex-based matching... | General purpose... |
| **[SolidJS Router](https://github.com/solidjs/solid-router)** | **98.3** | **9.23 KB** | Universal router for Solid with nested routing and... | General purpose... |
| **[Wouter](https://github.com/molefrog/wouter)** | **11.9** | **2.49 KB** | Minimalist-friendly ~2.1KB routing for React and P... | General purpose... |
...
| React Router | 44K | 0.025ms | 0.062ms | 1000 |

#### Static Route Matching

```
🥇 SolidJS Router     ████████████████████████████████████████   9.5M ops/sec
🥈 Zen Router         ██████████████████████████████████████     9.1M ops/sec
🥉 Wouter             ████████                                   2.0M ops/sec
 React Router                                                  44K ops/sec
```
...
| Library | ops/sec | Mean Time | P99 | Samples |
|---------|---------|-----------|-----|----------|
| SolidJS Router | 9.5M | 0.000ms | 0.000ms | 1000 |
| Zen Router | 9.1M | 0.000ms | 0.000ms | 1000 |
| Wouter | 2.0M | 0.001ms | 0.001ms | 1000 |
| React Router | 44K | 0.025ms | 0.056ms | 1000 |
...
| Wouter | 460K | 0.002ms | 0.005ms | 1000 |
| React Router | 53K | 0.020ms | 0.034ms | 1000 |
...
| Wouter | 232K | 0.004ms | 0.007ms | 1000 |
...
| Wouter | 172K | 0.006ms | 0.009ms | 1000 |
...
| Wouter | 222K | 0.005ms | 0.008ms | 1000 |
| React Router | 48K | 0.022ms | 0.046ms | 1000 |
...
| React Router | 37K | 0.028ms | 0.041ms | 1000 |
...
| Zen Router | 545K | 0.002ms | 0.004ms | 1000 |
| Wouter | 55K | 0.019ms | 0.030ms | 1000 |
| React Router | 7K | 0.143ms | 0.172ms | 1000 |
...
| SolidJS Router | 1.7M | 0.001ms | 0.001ms | 1000 |
| Zen Router | 1.7M | 0.001ms | 0.001ms | 1000 |
| Wouter | 196K | 0.006ms | 0.016ms | 1000 |
...
*Generated on 2025-11-13T17:32:30.580Z*
