...
- **⚡ Maximum Performance**: Zen - Fastest overall with 83.8/100 score
- **⚖️ Best Balance**: Solid Signals - Great performance (79.8/100) with good ecosystem
...
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Zen](https://github.com/SylphxAI/zen)** | 83.8/100 | 100% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen) [📊](https://bundlephobia.com/package/@sylphx/zen) |
| 🥈 2 | **[Solid Signals](https://github.com/solidjs/solid)** | 79.8/100 | 95% of fastest | [📦](https://www.npmjs.com/package/solid-js) [📊](https://bundlephobia.com/package/solid-js) |
| 🥉 3 | **[Preact Signals](https://github.com/preactjs/signals)** | 73.4/100 | 88% of fastest | [📦](https://www.npmjs.com/package/@preact/signals) [📊](https://bundlephobia.com/package/@preact/signals) |
|  4 | **[Valtio](https://github.com/pmndrs/valtio)** | 44.8/100 | 53% of fastest | [📦](https://www.npmjs.com/package/valtio) [📊](https://bundlephobia.com/package/valtio) |
|  5 | **[Zustand](https://github.com/pmndrs/zustand)** | 44.5/100 | 53% of fastest | [📦](https://www.npmjs.com/package/zustand) [📊](https://bundlephobia.com/package/zustand) |
|  6 | **[MobX](https://github.com/mobxjs/mobx)** | 35.3/100 | 42% of fastest | [📦](https://www.npmjs.com/package/mobx) [📊](https://bundlephobia.com/package/mobx) |
|  7 | **[Redux Toolkit](https://github.com/reduxjs/redux-toolkit)** | 15.5/100 | 18% of fastest | [📦](https://www.npmjs.com/package/@reduxjs/toolkit) [📊](https://bundlephobia.com/package/@reduxjs/toolkit) |
...
|---------|:-----:|:------------------:|-------------|----------|
| **[Zen](https://github.com/SylphxAI/zen)** | **83.8** | **1.66 KB** | Minimal and fast state management with signal-base... | Similar performance to Preact, slightly ... |
...
| **[Preact Signals](https://github.com/preactjs/signals)** | **73.4** | **3.04 KB** | Fast and reactive signals for Preact and React wit... | Excellent balance of speed and bundle si... |
| **[Valtio](https://github.com/pmndrs/valtio)** | **44.8** | **2.66 KB** | Proxy-based state management library that makes st... | Simple API, moderate performance, good f... |
...
| **[MobX](https://github.com/mobxjs/mobx)** | **35.3** | **17.56 KB** | Simple, scalable state management with transparent... | Automatic tracking, slow creation, large... |
| **[Redux Toolkit](https://github.com/reduxjs/redux-toolkit)** | **15.5** | **13.83 KB** | The official, opinionated, batteries-included tool... | Feature-rich, DevTools support, larger b... |
...
| Preact Signals | 15.7M | 0.000ms | 0.000ms | 1000 |
...
| Preact Signals | 19.3M | 0.000ms | 0.000ms | 1000 |
...
| Preact Signals | 30K | 0.036ms | 0.050ms | 1000 |
...
| Preact Signals | 511K | 0.002ms | 0.002ms | 1000 |
| Zen | 462K | 0.002ms | 0.003ms | 1000 |
...
| Preact Signals | 116K | 0.009ms | 0.012ms | 1000 |
| Zen | 113K | 0.009ms | 0.014ms | 1000 |
...
| Preact Signals | 22K | 0.051ms | 0.179ms | 1000 |
| Zen | 20K | 0.057ms | 0.311ms | 1000 |
...
| Zen | 157K | 0.007ms | 0.010ms | 1000 |
| Preact Signals | 137K | 0.008ms | 0.012ms | 1000 |
...
| Library | ops/sec | Mean Time | P99 | Samples |
|---------|---------|-----------|-----|----------|
| Preact Signals | 248K | 0.005ms | 0.006ms | 1000 |
| Zen | 221K | 0.006ms | 0.014ms | 1000 |
...
| Preact Signals | 516K | 0.002ms | 0.004ms | 1000 |
...
| Preact Signals | 928K | 0.001ms | 0.001ms | 1000 |
...
| Preact Signals | 4.1M | 0.000ms | 0.000ms | 1000 |
...
*Generated on 2025-11-13T23:06:28.174Z*
