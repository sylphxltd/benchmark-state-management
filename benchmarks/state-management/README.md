...
- **⚡ Maximum Performance**: Solid Signals - Fastest overall with 85.3/100 score
- **⚖️ Best Balance**: Zen - Great performance (51.0/100) with good ecosystem
...
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Solid Signals](https://github.com/solidjs/solid)** | 86.3/100 | 100% of fastest | [📦](https://www.npmjs.com/package/solid-js) [📊](https://bundlephobia.com/package/solid-js) |
| 🥈 2 | **[Zustand](https://github.com/pmndrs/zustand)** | 49.5/100 | 57% of fastest | [📦](https://www.npmjs.com/package/zustand) [📊](https://bundlephobia.com/package/zustand) |
| 🥉 3 | **[Zen](https://github.com/SylphxAI/zen)** | 48.2/100 | 56% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen) [📊](https://bundlephobia.com/package/@sylphx/zen) |
|  4 | **[Preact Signals](https://github.com/preactjs/signals)** | 32.9/100 | 38% of fastest | [📦](https://www.npmjs.com/package/@preact/signals) [📊](https://bundlephobia.com/package/@preact/signals) |
...
| 🥈 2 | **[Zen](https://github.com/SylphxAI/zen)** | 51.0/100 | 60% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen) [📊](https://bundlephobia.com/package/@sylphx/zen) |
...
|  4 | **[Preact Signals](https://github.com/preactjs/signals)** | 35.5/100 | 42% of fastest | [📦](https://www.npmjs.com/package/@preact/signals) [📊](https://bundlephobia.com/package/@preact/signals) |
...
|---------|:-----:|:------------------:|-------------|----------|
| **[Solid Signals](https://github.com/solidjs/solid)** | **85.3** | **3.96 KB** | Fine-grained reactivity primitive from Solid.js fo... | Fastest overall, but requires Solid.js e... |
| **[Zen](https://github.com/SylphxAI/zen)** | **51.0** | **1.66 KB** | Minimal and fast state management with signal-base... | Similar performance to Preact, slightly ... |
...
| **[Preact Signals](https://github.com/preactjs/signals)** | **35.5** | **3.04 KB** | Fast and reactive signals for Preact and React wit... | Excellent balance of speed and bundle si... |
...
| Zen | 501K | 0.002ms | 0.004ms | 1000 |
| Redux Toolkit | 191K | 0.005ms | 0.008ms | 1000 |
| Preact Signals | 108K | 0.009ms | 0.017ms | 1000 |
...
| Library | ops/sec | Mean Time | P99 | Samples |
|---------|---------|-----------|-----|----------|
| Zen | 22.9M | 0.000ms | 0.000ms | 1000 |
...
| Zen | 916 | 1.106ms | 2.143ms | 1000 |
| Preact Signals | 911 | 1.115ms | 2.143ms | 1000 |
...
| Zen | 151K | 0.007ms | 0.012ms | 1000 |
| Preact Signals | 130K | 0.008ms | 0.012ms | 1000 |
...
| Preact Signals | 20K | 0.052ms | 0.093ms | 1000 |
...
| Zen | 12K | 0.085ms | 0.106ms | 1000 |
| Preact Signals | 8K | 0.118ms | 0.130ms | 1000 |

#### Large Array (1000 items)

```
🥇 Zen                ████████████████████████████████████████   147K ops/sec
🥈 Preact Signals     ████████████████████████████████████████   147K ops/sec
...
| Library | ops/sec | Mean Time | P99 | Samples |
|---------|---------|-----------|-----|----------|
| Zen | 147K | 0.007ms | 0.012ms | 1000 |
| Preact Signals | 147K | 0.007ms | 0.009ms | 1000 |
...
*Generated on 2025-11-15T12:08:19.628Z*
