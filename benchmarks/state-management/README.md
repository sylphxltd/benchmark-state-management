...
- **⚡ Maximum Performance**: Solid Signals - Fastest overall with 84.4/100 score
- **⚖️ Best Balance**: Zen - Great performance (50.8/100) with good ecosystem
...
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Solid Signals](https://github.com/solidjs/solid)** | 77.6/100 | 100% of fastest | [📦](https://www.npmjs.com/package/solid-js) [📊](https://bundlephobia.com/package/solid-js) |
| 🥈 2 | **[Zustand](https://github.com/pmndrs/zustand)** | 44.2/100 | 57% of fastest | [📦](https://www.npmjs.com/package/zustand) [📊](https://bundlephobia.com/package/zustand) |
| 🥉 3 | **[Zen](https://github.com/SylphxAI/zen)** | 40.4/100 | 52% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen) [📊](https://bundlephobia.com/package/@sylphx/zen) |
|  4 | **[Preact Signals](https://github.com/preactjs/signals)** | 28.5/100 | 37% of fastest | [📦](https://www.npmjs.com/package/@preact/signals) [📊](https://bundlephobia.com/package/@preact/signals) |
|  5 | **[Valtio](https://github.com/pmndrs/valtio)** | 25.7/100 | 33% of fastest | [📦](https://www.npmjs.com/package/valtio) [📊](https://bundlephobia.com/package/valtio) |
|  6 | **[MobX](https://github.com/mobxjs/mobx)** | 25.0/100 | 32% of fastest | [📦](https://www.npmjs.com/package/mobx) [📊](https://bundlephobia.com/package/mobx) |
...
| Rank | Library | Overall Score | Relative Performance | Links |
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Solid Signals](https://github.com/solidjs/solid)** | 84.4/100 | 100% of fastest | [📦](https://www.npmjs.com/package/solid-js) [📊](https://bundlephobia.com/package/solid-js) |
| 🥈 2 | **[Zen](https://github.com/SylphxAI/zen)** | 50.8/100 | 60% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen) [📊](https://bundlephobia.com/package/@sylphx/zen) |
...
|  4 | **[Preact Signals](https://github.com/preactjs/signals)** | 34.7/100 | 41% of fastest | [📦](https://www.npmjs.com/package/@preact/signals) [📊](https://bundlephobia.com/package/@preact/signals) |
|  5 | **[Valtio](https://github.com/pmndrs/valtio)** | 34.4/100 | 41% of fastest | [📦](https://www.npmjs.com/package/valtio) [📊](https://bundlephobia.com/package/valtio) |
|  6 | **[MobX](https://github.com/mobxjs/mobx)** | 27.6/100 | 33% of fastest | [📦](https://www.npmjs.com/package/mobx) [📊](https://bundlephobia.com/package/mobx) |
...
|---------|:-----:|:------------------:|-------------|----------|
| **[Solid Signals](https://github.com/solidjs/solid)** | **84.4** | **3.96 KB** | Fine-grained reactivity primitive from Solid.js fo... | Fastest overall, but requires Solid.js e... |
| **[Zen](https://github.com/SylphxAI/zen)** | **50.8** | **1.66 KB** | Minimal and fast state management with signal-base... | Similar performance to Preact, slightly ... |
...
| **[Preact Signals](https://github.com/preactjs/signals)** | **34.7** | **3.04 KB** | Fast and reactive signals for Preact and React wit... | Excellent balance of speed and bundle si... |
| **[Valtio](https://github.com/pmndrs/valtio)** | **34.4** | **2.66 KB** | Proxy-based state management library that makes st... | Simple API, moderate performance, good f... |
...
| Zen | 403K | 0.003ms | 0.004ms | 1000 |
| Redux Toolkit | 191K | 0.005ms | 0.008ms | 1000 |
| Preact Signals | 119K | 0.008ms | 0.013ms | 1000 |
...
| Library | ops/sec | Mean Time | P99 | Samples |
|---------|---------|-----------|-----|----------|
| Zen | 23.4M | 0.000ms | 0.000ms | 1000 |
...
| Zen | 677 | 1.699ms | 2.871ms | 1000 |
| Preact Signals | 667 | 1.720ms | 2.872ms | 1000 |
...
| Preact Signals | 120K | 0.009ms | 0.015ms | 1000 |
...
| Zen | 14K | 0.073ms | 0.089ms | 1000 |
| Preact Signals | 9K | 0.115ms | 0.129ms | 1000 |

#### Large Array (1000 items)

```
🥇 Preact Signals     ████████████████████████████████████████   340K ops/sec
🥈 Zen                ██████████████████████                     184K ops/sec
...
| Library | ops/sec | Mean Time | P99 | Samples |
|---------|---------|-----------|-----|----------|
| Preact Signals | 340K | 0.004ms | 0.005ms | 1000 |
| Zen | 184K | 0.006ms | 0.009ms | 1000 |
...
| Preact Signals | 577K | 0.002ms | 0.002ms | 1000 |
...
| Zen | 596K | 0.002ms | 0.002ms | 1000 |
| Redux Toolkit | 290K | 0.003ms | 0.010ms | 1000 |
| Preact Signals | 271K | 0.004ms | 0.007ms | 1000 |
...
- **[Zen](https://github.com/SylphxAI/zen)** (`@sylphx/zen`) v3.1.1 • 1.66 KB gzip - [📦 npm](https://www.npmjs.com/package/@sylphx/zen) • [📊 bundle size](https://bundlephobia.com/package/@sylphx/zen)
...
*Generated on 2025-11-14T13:29:24.512Z*
